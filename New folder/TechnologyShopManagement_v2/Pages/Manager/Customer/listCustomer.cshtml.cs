...
namespace TechnologyShopManagement_v2.Pages.Manager.Customer
{
    public class listCustomerModel : PageModel
    {
        ...
        public listCustomerModel(Technology_ManagementContext db, IConfiguration configuration)
        {
                 ...
                 string currentFilter, string searchString, int? pageIndex)
        {
            ...
            IQueryable<Account> accountIQ = _db.Accounts.Where(s => s.Role == 0);
            ...
            if (!String.IsNullOrEmpty(searchString))
            {
                ...
                accountIQ = accountIQ.Where(s => ((s.Name.Contains(searchString) || s.UserId == number || s.Username.Contains(searchString) || s.Email.Contains(searchString) || s.PhoneNumber.Contains(searchString)) && s.Role == 0));
            }
