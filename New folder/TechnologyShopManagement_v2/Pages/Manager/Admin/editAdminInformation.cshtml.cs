...
namespace TechnologyShopManagement_v2.Pages.Manager.Admin
{
    ...
    public class editAdminInformationModel : PageModel
    {
        ...
        public editAdminInformationModel(Technology_ManagementContext db)
        {
            _db = db;
        }
        ...
        public async Task<IActionResult> OnPost()
        {
            ...
            if (checkDup == true)
            {
                if (account.Email.Equals(currentEmail))
                {
                    ...
                    messError = "";
                    return Redirect("/Manager/Admin/adminManager");
                }
                messError = "Email is already exist !!!";
                return Redirect("/Manager/Admin/editAdminInformation");
            }
            else
            {
