...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=LAPTOP-QTGOPG68;Initial Catalog=Technology_Management;Persist Security Info=true;TrustServerCertificate=True;User ID=sa;Password=123456");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AccountDetail>(entity =>
            {
                ...
                entity.HasIndex(e => e.UserId, "IX_AccountDetail_UserID");
            ...
            modelBuilder.Entity<Category>(entity =>
            {
                ...
                entity.HasIndex(e => e.SubCatCode, "IX_Category_SubCatCode");
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.HasIndex(e => e.CategoryCode, "IX_Product_CategoryCode");
